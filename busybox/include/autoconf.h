 ...
 */
#define AUTOCONF_TIMESTAMP "2026-01-05 14:53:16 CET"
...
#define ENABLE_FEATURE_VERSION 0
#define IF_FEATURE_VERSION(...)
#define IF_NOT_FEATURE_VERSION(...) __VA_ARGS__
...
#define CONFIG_NO_LOOP_CONFIGURE 1
#define ENABLE_NO_LOOP_CONFIGURE 1
#ifdef MAKE_SUID
# define IF_NO_LOOP_CONFIGURE(...) __VA_ARGS__ "CONFIG_NO_LOOP_CONFIGURE"
#else
# define IF_NO_LOOP_CONFIGURE(...) __VA_ARGS__
#endif
#define IF_NOT_NO_LOOP_CONFIGURE(...)
#undef CONFIG_TRY_LOOP_CONFIGURE
#define ENABLE_TRY_LOOP_CONFIGURE 0
#define IF_TRY_LOOP_CONFIGURE(...)
#define IF_NOT_TRY_LOOP_CONFIGURE(...) __VA_ARGS__
